...
function generateHash(obj) {
  // Write your code here
  let a = sha256(JSON.stringify(obj));
  return sha256(JSON.stringify(obj));
}

function nativeNodeHash(obj) {
...
console.log(`SHA256 Hash: ${nativeNodeHash(data1)}`);
console.log("************************************");
console.log(`SHA256 Hash: ${generateHash(dataObject)}`);
console.log(`SHA256 Hash: ${nativeNodeHash(dataObject)}`);
